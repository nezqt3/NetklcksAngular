...
const films = [
    {
        ...
        rating: 7.8,
        link: "/film.html",
        image: "./images/Картинка фильма.png"
    },
    {
        id: 1,
        title: "Марсианин 2",
    ...
    array.forEach((item) => {
        cardWrapper.insertAdjacentHTML("beforeend", `
            ...
            <div class="content-cards__item--title">
                ...
                <p class="content-cards__item--description">${item.category}</p>
...
searchButton.addEventListener('click', () => {
    render(films.filter((item) => item.title.includes(searchInput.value) && searchInput.value != ''));
})
